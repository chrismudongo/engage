...
class SurveyResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create survey_response" do
    assert_difference('SurveyResponse.count') do
      post survey_responses_url, params: { survey_response: { email: @survey_response.email, responses: @survey_response.responses, surveyID: @survey_response.surveyID, user_group: @survey_response.user_group } }
    end
  ...
  test "should update survey_response" do
    patch survey_response_url(@survey_response), params: { survey_response: { email: @survey_response.email, responses: @survey_response.responses, surveyID: @survey_response.surveyID, user_group: @survey_response.user_group } }
