class GridFsFilesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @grid_fs_file.save
        format.html { redirect_to @grid_fs_file, notice: 'News media file was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @grid_fs_file.update(grid_fs_file_params)
        format.html { redirect_to @grid_fs_file, notice: 'News media file was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to grid_fs_files_url, notice: 'News media file was successfully destroyed.' }
  ...
  private
    ...
    def grid_fs_file_params
      params.require(:grid_fs_file).permit(:filename, :contentType, :user_group, :author, :topic, :uploadDate, :length, :chunkSize, :md5, :contents, :status, :survey_id)
    end
end
